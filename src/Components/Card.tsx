...
const Card = ({ product }: Props) => {
  return (
    <div className="h-[auto] hover:scale-105 p-3 transition duration-200 bg-white w-full rounded-xl shadow-cardshadow cursor-pointer">
      ...
      <div className="px-1 mt-2 space-y-1">
        ...
        <div className="flex relative">
          ...
          <img
            ...
            alt=""
          />
          <div className="text-sm font-semibold text-white ml-16 px-3 py-[3px] rounded-full bg-cartbtnred">{product.discountPercent}%</div>
        </div>
